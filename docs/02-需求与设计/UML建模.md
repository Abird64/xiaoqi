...
> **状态**：系统边界 + Actor + 2 张用例图 + 10 条用例清单已成稿；
> 用例规格（UC-01/02/03/06）、业务规则 BR、量化 NFR 已于 2026-09-20 补齐 → 见 [需求规格说明书.md](需求规格说明书.md)（实训课交付物 D1）
> **主笔**：成员 A（张鹏）｜ **需评审**：B、D
>
> 相关：[需求规格说明书](需求规格说明书.md) ｜ [需求分析](需求分析.md) ｜ [系统架构](系统架构.md) ｜ [接口协议](接口协议.md) ｜ 项目事实见 [仓库 README](../../README.md)
